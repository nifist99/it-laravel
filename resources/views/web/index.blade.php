    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="row portfolio-container">
          @foreach($project as $ject)
          <div class="col-lg-4 col-md-6 portfolio-item">
            <div class="portfolio-wrap">
              <img src="{{url($ject->foto)}}" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>{{$ject->nama}}</h4>
                <p>{{$ject->singkatan}}</p>
                <div class="portfolio-links">
                  <a href="{{url($ject->foto)}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$ject->nama}}"><i class="bx bx-plus"></i></a>
                  <a href="{{url('detail_project/'.$ject->id)}}" class="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
