...
<main id="main">
    ...
    <section id="section-about" class="section-service d-flex justify-content-center align-items-center">
            <p class="font-heading">Blog & Artikel About Technologi</p>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{url('assets/img/blog/blog-2.jpg')}}" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{url('assets/img/blog/blog-3.jpg')}}" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{url('assets/img/blog/blog-4.jpg')}}" alt="" class="img-fluid">
              </div>
