<?php namespace App\Http\Controllers;
	...
	class AdminDbCustomerController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Db Kategori Service','name'=>'id_db_kategori_service','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'db_kategori_service,nama'];
			...
			$this->form[] = ['label'=>'Note','name'=>'note','type'=>'textarea','validation'=>'required|string|min:1|max:5000','width'=>'col-sm-10'];
