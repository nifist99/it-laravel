<?php namespace App\Http\Controllers;
	...
	class AdminDbWebTestimoniController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		public function getSetStatus($status,$id) {
			DB::table('db_web_testimoni')->where('id',$id)->update(['status'=>$status]);
